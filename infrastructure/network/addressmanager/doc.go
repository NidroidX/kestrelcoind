/*
Package addressmanager implements concurrency safe kestrelcoin address manager.

# Address Manager Overview

In order maintain the peer-to-peer kestrelcoin network, there needs to be a source
of addresses to connect to as nodes come and go. The kestrelcoin protocol provides
