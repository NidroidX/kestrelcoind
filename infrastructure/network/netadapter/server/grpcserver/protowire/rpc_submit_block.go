...
func (x *kestrelcoindMessage_SubmitBlockRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *kestrelcoindMessage_SubmitBlockRequest) fromAppMessage(message *appmessage.SubmitBlockRequestMessage) error {
...
func (x *kestrelcoindMessage_SubmitBlockResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "kestrelcoindMessage_SubmitBlockResponse is nil")
	}
	return x.SubmitBlockResponse.toAppMessage()
}

func (x *kestrelcoindMessage_SubmitBlockResponse) fromAppMessage(message *appmessage.SubmitBlockResponseMessage) error {
	var err *RPCError
