...
func (x *kestrelcoindMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "kestrelcoindMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *kestrelcoindMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {
