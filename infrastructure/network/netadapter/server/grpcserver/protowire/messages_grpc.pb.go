...
type P2P_MessageStreamClient interface {
	Send(*kestrelcoindMessage) error
	Recv() (*kestrelcoindMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *kestrelcoindMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*kestrelcoindMessage, error) {
	m := new(kestrelcoindMessage)
...
func (x *p2PMessageStreamServer) Send(m *kestrelcoindMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*kestrelcoindMessage, error) {
	m := new(kestrelcoindMessage)
...
func (x *rPCMessageStreamClient) Send(m *kestrelcoindMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*kestrelcoindMessage, error) {
	m := new(kestrelcoindMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *kestrelcoindMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*kestrelcoindMessage, error) {
	m := new(kestrelcoindMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
