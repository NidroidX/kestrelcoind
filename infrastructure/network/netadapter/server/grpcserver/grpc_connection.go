...
type grpcStream interface {
	Send(*protowire.kestrelcoindMessage) error
	Recv() (*protowire.kestrelcoindMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.kestrelcoindMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.kestrelcoindMessage) error {
