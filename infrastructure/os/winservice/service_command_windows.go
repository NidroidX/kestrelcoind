...
// installService attempts to install the kestrelcoind Service. Typically this should
...
// removeService attempts to uninstall the kestrelcoind Service. Typically this should
...
// startService attempts to Start the kestrelcoind Service.
