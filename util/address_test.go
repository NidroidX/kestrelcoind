...
func TestAddresses(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "mainnet p2pk",
			addr:    "kestrelcoin:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35cdv0dy335",
			encoded: "kestrelcoin:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35cdv0dy335",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32Prefixkestrelcoin,
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c}
				return util.NewAddressPublicKey(publicKey, util.Bech32Prefixkestrelcoin)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32Prefixkestrelcoin,
		},
		{
			name:    "mainnet p2pk 2",
			addr:    "kestrelcoin:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
			encoded: "kestrelcoin:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32Prefixkestrelcoin,
				[util.PublicKeySize]byte{
			...
			passedPrefix:   util.Bech32Prefixkestrelcoin,
			expectedPrefix: util.Bech32Prefixkestrelcoin,
		},
		{
			name:    "testnet p2pk",
			addr:    "kestrelcointest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35ckquw528z",
			encoded: "kestrelcointest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35ckquw528z",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixkestrelcoinTest,
				[util.PublicKeySize]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixkestrelcoinTest)
			},
			passedPrefix:   util.Bech32PrefixkestrelcoinTest,
			expectedPrefix: util.Bech32PrefixkestrelcoinTest,
		},

		// ECDSA P2PK tests.
		{
			name:    "mainnet ecdsa p2pk",
			addr:    "kestrelcoin:qyp0r5mcq4rd5grj3652ra09u5dcgwqq9ntuswp247nama5quyj40eq03sc2dkx",
			encoded: "kestrelcoin:qyp0r5mcq4rd5grj3652ra09u5dcgwqq9ntuswp247nama5quyj40eq03sc2dkx",
			valid:   true,
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKeyECDSA(publicKey, util.Bech32Prefixkestrelcoin)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32Prefixkestrelcoin,
		},
		...
		},
		{
			...
			addr:           "kestrelcoin:qr35ennsep3hxfe7lnz5ee7j5jgmkjswss74as46gx",
			valid:          false,
			passedPrefix:   util.Bech32Prefixkestrelcoin,
			expectedPrefix: util.Bech32Prefixkestrelcoin,
		},
		...
		{
			name:    "mainnet p2sh",
			addr:    "kestrelcoin:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
			encoded: "kestrelcoin:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
			valid:   true,
			...
			f: func() (util.Address, error) {
				script := []byte{
					...
					0xae}
				return util.NewAddressScriptHash(script, util.Bech32Prefixkestrelcoin)
			},
			passedPrefix:   util.Bech32Prefixkestrelcoin,
			expectedPrefix: util.Bech32Prefixkestrelcoin,
		},
		{
			name:    "mainnet p2sh 2",
			addr:    "kestrelcoin:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
			encoded: "kestrelcoin:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32Prefixkestrelcoin,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32Prefixkestrelcoin)
			},
			passedPrefix:   util.Bech32Prefixkestrelcoin,
			expectedPrefix: util.Bech32Prefixkestrelcoin,
		},
		{
			name:    "testnet p2sh",
			addr:    "kestrelcointest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vx35yyy2h9",
			encoded: "kestrelcointest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vx35yyy2h9",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixkestrelcoinTest,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixkestrelcoinTest)
			},
			passedPrefix:   util.Bech32PrefixkestrelcoinTest,
			expectedPrefix: util.Bech32PrefixkestrelcoinTest,
		},
...
func TestDecodeAddressErrorConditions(t *testing.T) {
	tests := []struct {
		...
		{
			"kestrelcoinsim:raskzctpv9skzctpv9skzctpv9skzctpvy37ct7zafpv9skzctpvymmnd3gh8",
			util.Bech32PrefixkestrelcoinSim,
			"unknown address type",
		},
		{
			"kestrelcoinsim:raskzcg58mth0an",
			util.Bech32PrefixkestrelcoinSim,
			"unknown address type",
		},
		{
			"kestrelcointest:qqq65mvpxcmajeq44n2n8vfn6u9f8l4zsy0xez0tzw",
			util.Bech32Prefixkestrelcoin,
...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"kestrelcoin", util.Bech32Prefixkestrelcoin, false},
		{"kestrelcointest", util.Bech32PrefixkestrelcoinTest, false},
		{"kestrelcoinsim", util.Bech32PrefixkestrelcoinSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32Prefixkestrelcoin, "kestrelcoin"},
		{util.Bech32PrefixkestrelcoinTest, "kestrelcointest"},
		{util.Bech32PrefixkestrelcoinSim, "kestrelcoinsim"},
		{util.Bech32PrefixUnknown, ""},
	}
