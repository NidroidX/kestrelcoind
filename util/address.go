...
const (
	...
	Bech32Prefixkestrelcoin

	// Prefix for the dev network.
	Bech32PrefixkestrelcoinDev

	// Prefix for the test network.
	Bech32PrefixkestrelcoinTest

	// Prefix for the simulation network.
	Bech32PrefixkestrelcoinSim
)
...
var stringsToBech32Prefixes = map[string]Bech32Prefix{
	"kestrelcoin":     Bech32Prefixkestrelcoin,
	"kestrelcoindev":  Bech32PrefixkestrelcoinDev,
	"kestrelcointest": Bech32PrefixkestrelcoinTest,
	"kestrelcoinsim":  Bech32PrefixkestrelcoinSim,
}
...
// and a payload which encodes the kestrelcoin network and address type. It is used
...
// with the passed kestrelcoin network.
