...
// Params defines a kestrelcoin network by its parameters. These parameters may be
// used by kestrelcoin applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// Further details: https://hashdag.medium.com/kestrelcoin-launch-plan-9a63f4d754a6
	...
	// PruningProofM is the 'm' constant in the pruning proof. For more details see: https://github.com/kestrelcoincoin/research/issues/3
...
// MainnetParams defines the network parameters for the main kestrelcoin network.
var MainnetParams = Params{
	...
	Prefix: util.Bech32Prefixkestrelcoin,
...
// TestnetParams defines the network parameters for the test kestrelcoin network.
var TestnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "kestrelcoin-testnet-10",
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixkestrelcoinTest,
...
// SimnetParams defines the network parameters for the simulation test kestrelcoin
...
var SimnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixkestrelcoinSim,
...
// DevnetParams defines the network parameters for the development kestrelcoin network.
var DevnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixkestrelcoinDev,
...
// ErrDuplicateNet describes an error where the parameters for a kestrelcoin
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate kestrelcoin network")

var registeredNets = make(map[appmessage.kestrelcoinNet]struct{})

// Register registers the network parameters for a kestrelcoin network. This may
