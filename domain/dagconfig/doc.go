...
In addition to the main kestrelcoin network, which is intended for the transfer
...
If an application does not use one of the standard kestrelcoin networks, a new
