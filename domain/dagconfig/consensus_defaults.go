...
const (
	...
	defaultSubsidyGenesisReward                    = 1 * constants.SiumPerkestrelcoin
	defaultPreDeflationaryPhaseBaseSubsidy         = 500 * constants.SiumPerkestrelcoin
	defaultDeflationaryPhaseBaseSubsidy            = 440 * constants.SiumPerkestrelcoin
