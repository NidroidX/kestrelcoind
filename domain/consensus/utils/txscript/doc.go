/*
Package txscript implements the kestrelcoin transaction script language.

This package provides data structures and functions to parse and execute
kestrelcoin transaction scripts.

# Script Overview

kestrelcoin transaction scripts are written in a stack-base, FORTH-like language.

The kestrelcoin script language consists of a number of opcodes which fall into
...
Typical kestrelcoin scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend kestrelcoin.
