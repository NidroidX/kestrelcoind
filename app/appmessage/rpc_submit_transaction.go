...
// RPCTransaction is a kestrelcoind transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a kestrelcoind transaction input representation
...
// RPCScriptPublicKey is a kestrelcoind ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a kestrelcoind transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a kestrelcoind outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a kestrelcoind utxo entry representation meant to be used
// over RPC
