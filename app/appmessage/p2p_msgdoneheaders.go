...
// MsgDoneHeaders implements the Message interface and represents a kestrelcoin
...
// NewMsgDoneHeaders returns a new kestrelcoin DoneIBDBlocks message that conforms to the
// Message interface.
