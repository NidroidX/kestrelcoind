...
// MsgIBDChainBlockLocator implements the Message interface and represents a kestrelcoin
...
// NewMsgIBDChainBlockLocator returns a new kestrelcoin locator message that conforms to
