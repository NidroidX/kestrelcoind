...
// MsgPing implements the Message interface and represents a kestrelcoin ping
// message.
//
...
// NewMsgPing returns a new kestrelcoin ping message that conforms to the Message
