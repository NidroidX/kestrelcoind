...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a kestrelcoin
...
// NewMsgDoneBlocksWithTrustedData returns a new kestrelcoin DoneBlocksWithTrustedData message that conforms to the
// Message interface.
