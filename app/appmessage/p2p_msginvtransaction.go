...
// MsgInvTransaction implements the Message interface and represents a kestrelcoin
...
// NewMsgInvTransaction returns a new kestrelcoin TxInv message that conforms to
