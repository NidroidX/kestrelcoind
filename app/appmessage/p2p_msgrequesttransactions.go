...
// MsgRequestTransactions implements the Message interface and represents a kestrelcoin
...
// NewMsgRequestTransactions returns a new kestrelcoin RequestTransactions message that conforms to
