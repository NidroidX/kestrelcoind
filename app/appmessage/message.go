...
// Commands used in kestrelcoin message headers which describe the type of message.
const (
	// protocol
...
// Message is an interface that describes a kestrelcoin message. A type that
