...
// MsgInvRelayBlock implements the Message interface and represents a kestrelcoin
...
// NewMsgInvBlock returns a new kestrelcoin invrelblk message that conforms to
