...
// MsgBlockLocator implements the Message interface and represents a kestrelcoin
...
// NewMsgBlockLocator returns a new kestrelcoin locator message that conforms to
