...
// MsgRequestRelayBlocks implements the Message interface and represents a kestrelcoin
...
// NewMsgRequestRelayBlocks returns a new kestrelcoin RequestRelayBlocks message that conforms to
