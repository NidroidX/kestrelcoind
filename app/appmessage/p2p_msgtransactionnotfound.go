...
// MsgTransactionNotFound defines a kestrelcoin TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new kestrelcoin transactionsnotfound message that conforms to the
