...
// MsgRequestHeaders implements the Message interface and represents a kestrelcoin
...
// NewMsgRequstHeaders returns a new kestrelcoin RequestHeaders message that conforms to the
