...
// kestrelcoin Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a kestrelcoin
// Addresses message.
...
// NewMsgAddresses returns a new kestrelcoin Addresses message that conforms to the
