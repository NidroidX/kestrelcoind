...
// MsgIBDBlock implements the Message interface and represents a kestrelcoin
...
// NewMsgIBDBlock returns a new kestrelcoin ibdblock message that conforms to the
