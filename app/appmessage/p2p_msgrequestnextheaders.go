...
// MsgRequestNextHeaders implements the Message interface and represents a kestrelcoin
...
// NewMsgRequestNextHeaders returns a new kestrelcoin RequestNextHeaders message that conforms to the
// Message interface.
