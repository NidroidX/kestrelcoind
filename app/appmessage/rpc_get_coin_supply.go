...
func NewGetCoinSupplyResponseMessage(maxSium uint64, circulatingSium uint64) *GetCoinSupplyResponseMessage {
	return &GetCoinSupplyResponseMessage{
		MaxSium:         maxSium,
		CirculatingSium: circulatingSium,
	}
}
