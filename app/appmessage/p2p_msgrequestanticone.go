...
// MsgRequestAnticone implements the Message interface and represents a kestrelcoin
...
// NewMsgRequestAnticone returns a new kestrelcoin RequestPastDiff message that conforms to the
