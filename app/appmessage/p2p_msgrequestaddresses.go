...
// MsgRequestAddresses implements the Message interface and represents a kestrelcoin
...
// NewMsgRequestAddresses returns a new kestrelcoin RequestAddresses message that conforms to the
